...
{
  printf("ppscap cli utility " PPSCAP_VERSION "\nCopyright (C) 2019\n");
  ...
  {
    printf("usage: \n"
           "  ppscap -d file.pcf fnout[.gif|.png]]  ; converts pcf file to gif (or PNGs)\n"
           "  ppscap -e file.[pcf|gif|png] [maxfps] ; encodes full screen until Ctrl+C\n"
